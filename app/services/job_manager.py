...
from app.services.clustering.minibatch import OnlineClusterer
    ...
    async def _run_job(self, job_id: str) -> None:
        ...
        try:
            ...
            clusterer = OnlineClusterer(
                ...
                batch_size=max(16, settings.MAX_IN_FLIGHT_IMAGES),
            )
            ...
            job.status = "failed"
            await self.bus.publish(job_id, {"type": "status", "status": "failed", "error": str(e)})
